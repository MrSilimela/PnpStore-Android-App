...
public class MealsFragment extends Fragment implements AsyncResponse {

    public static final String PREFS = "prefFile";
    final static String url = "https://pnponlineshopping1.000webhostapp.com/FetchMeals.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init(UILConfig.config(MealsFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(MealsFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                SharedPreferences preferences = MealsFragment.this.getActivity().getSharedPreferences(PREFS, 0);
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        MealsFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                       // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(MealsFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(MealsFragment.this.getActivity(), productList, R.layout.product_row, dic);
