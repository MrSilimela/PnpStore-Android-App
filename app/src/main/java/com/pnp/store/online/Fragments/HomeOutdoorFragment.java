 ...
 */
public class HomeOutdoorFragment extends Fragment implements AsyncResponse{

    public static final String PREFS = "prefFile";
    final static String url = "https://pnponlineshopping1.000webhostapp.com/FetchHomeOutdoor.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_home_outdoor, container, false);

        ImageLoader.getInstance().init(UILConfig.config(HomeOutdoorFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(HomeOutdoorFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                SharedPreferences preferences = HomeOutdoorFragment.this.getActivity().getSharedPreferences(PREFS, 0);
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        HomeOutdoorFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(HomeOutdoorFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(HomeOutdoorFragment.this.getActivity(), productList, R.layout.product_row, dic);
