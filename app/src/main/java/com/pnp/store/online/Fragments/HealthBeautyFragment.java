 ...
 */
public class HealthBeautyFragment extends Fragment implements AsyncResponse{

    public static final String PREFS = "prefFile";
    final static String url = "https://pnponlineshopping1.000webhostapp.com/FetchHealth.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_health_beauty, container, false);

        ImageLoader.getInstance().init(UILConfig.config(HealthBeautyFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(HealthBeautyFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                SharedPreferences preferences = HealthBeautyFragment.this.getActivity().getSharedPreferences(PREFS, 0);
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        HealthBeautyFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(HealthBeautyFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(HealthBeautyFragment.this.getActivity(), productList, R.layout.product_row, dic);
