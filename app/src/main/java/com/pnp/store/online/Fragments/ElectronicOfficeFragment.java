 ...
 */
public class ElectronicOfficeFragment extends Fragment implements AsyncResponse {
    public static final String PREFS = "prefFile";
    final static String url = "https://pnponlineshopping1.000webhostapp.com/FetchElectronics.php";
    ...
    public ElectronicOfficeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_electronic_office, container, false);

        ImageLoader.getInstance().init(UILConfig.config(ElectronicOfficeFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(ElectronicOfficeFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                SharedPreferences preferences = ElectronicOfficeFragment.this.getActivity().getSharedPreferences(PREFS, 0);
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        ElectronicOfficeFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                       // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(ElectronicOfficeFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(ElectronicOfficeFragment.this.getActivity(), productList, R.layout.product_row, dic);
