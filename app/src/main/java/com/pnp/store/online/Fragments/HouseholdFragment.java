 ...
 */
public class HouseholdFragment extends Fragment implements AsyncResponse{
    public static final String PREFS = "prefFile";

    final static String url = "https://pnponlineshopping1.000webhostapp.com/FetchHousehold.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init(UILConfig.config(HouseholdFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(HouseholdFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                SharedPreferences preferences = HouseholdFragment.this.getActivity().getSharedPreferences(PREFS, 0);
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        HouseholdFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(HouseholdFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(HouseholdFragment.this.getActivity(), productList, R.layout.product_row, dic);
